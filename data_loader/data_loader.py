...
# 3. 맨홀/나무밑둥 = cyan
label_list.append(["caution_zone_stairs", "caution_zone_manhole", "caution_zone_tree_zone", "caution_zone_grating",
...
def convert_class(label_img):
    for i in range(len(label_img)):
        ...
        label_img[i][(label_img[i] != 0) & (label_img[i] != 1) & (label_img[i] != 2) & (label_img[i] != 3)
                     & (label_img[i] != 4) & (label_img[i] != 5) & (label_img[i] != 6)] = 0
